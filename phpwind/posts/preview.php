...
<body style="overflow-x: hidden;">
			...
			<section class="purple-section">
				<div class="wrapper">
					...
					<div class="card-group clearfix">
       				...
       				?>
						<div class="card" post-value="<?php print $post->id; ?>">
							<!--input type="hidden" id="post-id" value="<?php print $post->id; ?>"-->
							<h3 post-value="<?php print $post->id; ?>" ><?php echo $post->title; ?></h3>
	...
	<script type="text/javascript">
		...
		document.querySelector('.card-group').addEventListener('click',
			function(){
				console.log('click');
				console.log(event.target);
				window.location.href='article.php?id='+ event.target.getAttribute('post-value');
		},true)
	</script>
